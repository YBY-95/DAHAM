...
def main(test_name, dataset_name, dataset_subname, domain_name_s, domain_name_t, lamda, omega,
    ...
    if 'cnn1' in test_name:
        ...
        feature.load_weights(
            './ckpt/pretrain/' + test_name + '/' + 'CWRUcnn1' + '/' + dataset_subname + '/' + domain_name_s + '-feature.ckpt')
        classifer.load_weights(
            './ckpt/pretrain/' + test_name + '/' + 'CWRUcnn1' + '/' + dataset_subname + '/' + domain_name_s + '-classifer.ckpt')
    ...
    for epoch in range(epochs + 1):
        ...
        if epoch % 500 == 0:
            ...
            # if os.path.exists(dir_fig) is None:
            #     os.mkdir(dir_fig)
            # sign = batch_st[0]
            # label = batch_st[1]
            # domain = batch_st[2]
