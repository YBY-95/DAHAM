...
from Mul_DACNN import Gfeature, Gy, GdWD
import os
import glob
...
def main(test_name, dataset_name, dataset_subname, domain_name_s, domain_name_t, lamda):
    ...
    for epoch in range(epochs + 1):
        ...
        with tf.GradientTape(persistent=True) as tape:
            ...
            feature_c_t = feature.call(sign_t, training=None)
            ...
            d_loss = 10*gp - wd_loss
            f_loss = c_loss + lamda*(wd_loss-10*gp)
        ...
        if epoch % 50 == 0:
            ...
            # # t_sne降维
            # dir_fig = './picture' + '/' + test_name + '/' + dataset_subname + '/' + '1/'
            # sign = batch_st[0]
            # label = batch_st[1]
            # domain = batch_st[2]
...
if __name__ == '__main__':
    ...
    for l in data_subname:
        ...
        wb.save('lamda1'+test_name+'-'+l+'-'+data_name+'.xlsx')
        wb.close()
        app.quit()

    # main('WD', 'CWRU', '021', '3', '0', 1)