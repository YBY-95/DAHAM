...
from Mul_DACNN import Gfeature, Gfeature1, Gfeature2, Gy, Gd
import os
import glob
...
def test_otherdomain(test_name, data_name, data_subname, test_data_domain, domain_name_s, domain_name_t, lamda):
    ...
    if 'cnn1' in test_name:
        ...
        classifer.build(input_shape=(batch_size, 4096))
        feature.load_weights(
            './ckpt/pretrain/' + 'CWRUcnn1' + '/' + data_subname + '/' + domain_name_s + '-feature.ckpt')
        classifer.load_weights(
            './ckpt/pretrain/' + 'CWRUcnn1' + '/' + data_subname + '/' + domain_name_s + '-classifer.ckpt')
        print('test modelload weights OK')
...
if __name__ == '__main__':
    ...
    # data_subname = '007'
    # lamda = 0.1
    # test_otherdomain(test_name, data_name, data_subname, '0', '0', '1', 1)
    # test_otherdomain(test_name, data_name, data_subname, '1', '0', '1', 1)
    # test_otherdomain(test_name, data_name, data_subname, '2', '0', '1', 1)
    # test_otherdomain(test_name, data_name, data_subname, '3', '0', '1', 1)
